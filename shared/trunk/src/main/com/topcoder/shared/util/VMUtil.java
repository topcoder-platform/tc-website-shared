...
public class VMUtil {
     ...
     * even between differents instances of the same application
     */
    public static String VM_INSTANCE_ID = System.getProperty("VM_INSTANCE_ID");
    
    /**
     * Returns the VM Identifier defined as System property when launching the curren VM. (VM_INSTANCE_ID)
     * 
     * @return the id
